...
data() {
    return {
      ...
      options: {
        ...
        customBackend: { "肥羊增强型后端【vless reality+hy1+hy2】": "https://url.v1.mk", "周润发HK后端": "https://subapi.zrfme.com", "CM负载均衡后端": "https://subapi.cmliussss.net", "CM应急备用后端": "https://subapi.fxxk.dedyn.io", "肥羊备用后端": "https://sub.d1.mk",
